"""
Daily "Love Notes" sender for the Diamond client group.
Clients can copy this message and forward it to their own spouse.
Works exactly like the other senders, reading from love_notes.json,
triggered by a separate scheduled workflow at 10:00 AM IST.
"""
...
MESSAGES_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "love_notes.json")
